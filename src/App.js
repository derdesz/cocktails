...
function App() {
  ...
  const [searchField, setSearchField] = useState(
    new URLSearchParams(window.location.search).get("search-field") ||
  ...
  function clickOnSpirit(spiritName) {
    ...
    document.getElementsByClassName(
      "hold-random-cocktail-container"
        ...
        <div className="wrapper">
          ...
          <div>
            <Route
              ...
              render={(props) => (
                <SpiritList
                  {...props}
                  clickOnSpiritNameForDescription={
                    clickOnSpiritNameForDescription
                  }
                />
              )}
          ...
          <div>
            <Route
              path="/by-spirit"
              render={(props) => (
                <BySpirit {...props} clickOnSpirit={clickOnSpirit} />
              )}
            />
          </div>
          <div className="spirit-list">
            <div
              className="hold-random-cocktail-container"
              id="random-cocktail-container"
            >
            ...
            <div>
              <div className="ui grid">
                ...
                />
                <Route
                  path={"/spirits/name/" + spiritDescriptionName}
                  render={(props) => (
                    <GetSpirit
                      {...props}
                      spiritDescriptionName={spiritDescriptionName}
                    />
                  )}
                />
              </div>
              <div id="single-item">
                <Route
                  path={"/cocktail/" + currentId}
                  render={(props) => (
                    <GetCocktailById {...props} cocktailId={currentId} />
                  )}
                />
              </div>
            </div>
